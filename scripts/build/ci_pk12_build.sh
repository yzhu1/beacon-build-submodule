...
find target/test/webdriver -name *Test.class \
  ...
  | /opt/wgen-3p/python26/bin/python conf/base/scripts/build/parallelTests.py -s yad124.tt.wgenhq.net -u autobuild -i /home/tomcat/.ssh/autobuild_key -w /home/autobuild/$JOB_NAME -v $apphomeenvvar -n $webdrivertestsperbatch -p $ENV_PROPERTY_PREFIX
